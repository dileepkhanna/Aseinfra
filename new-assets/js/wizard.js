...
function refreshAnimation(t, e) {
    total_steps = t.find("li").length, move_distance = t.width() / total_steps, step_width = move_distance, move_distance *= e, $current = e + 1, 1 == $current ? move_distance -= 8 : $current == total_steps && (move_distance += 8), t.find(".moving-tab").css("width", step_width), $(".moving-tab").css({
...
function debounce(t, e, i) {
    ...
    var e = function(e, i) {
        ...
        this.rebindClick = function(t, e) {
            ...
            if (a.length || (o.find("a:first").tab("show"), a = o.find(r + ":first")), t(s.previousSelector, e).toggleClass("disabled", n.firstIndex() >= n.currentIndex()), t(s.nextSelector, e).toggleClass("disabled", n.currentIndex() >= n.navigationLength()), n.rebindClick(t(s.nextSelector, e), n.next), n.rebindClick(t(s.previousSelector, e), n.previous), n.rebindClick(t(s.lastSelector, e), n.last), n.rebindClick(t(s.firstSelector, e), n.first), s.onTabShow && "function" == typeof s.onTabShow && !1 === s.onTabShow(a, o, n.currentIndex())) return !1
        }, this.next = function(t) {
            return !e.hasClass("last") && ((!s.onNext || "function" != typeof s.onNext || !1 !== s.onNext(a, o, n.nextIndex())) && ($index = n.nextIndex(), void($index > n.navigationLength() || o.find(r + ":eq(" + $index + ") a").tab("show"))))
        }, this.previous = function(t) {
            return !e.hasClass("first") && ((!s.onPrevious || "function" != typeof s.onPrevious || !1 !== s.onPrevious(a, o, n.previousIndex())) && ($index = n.previousIndex(), void($index < 0 || o.find(r + ":eq(" + $index + ") a").tab("show"))))
        ...
        var l = function(e) {
                ...
                if (s.onTabClick && "function" == typeof s.onTabClick && !1 === s.onTabClick(a, o, n.currentIndex(), i)) return !1
            },
            d = function(e) {
                $element = t(e.target).parent();
                var i = o.find(r).index($element);
                return !$element.hasClass("disabled") && ((!s.onTabChange || "function" != typeof s.onTabChange || !1 !== s.onTabChange(a, o, n.currentIndex(), i)) && (a = $element, void n.fixNavigationButtons()))
            };
        this.resetWizard = function() {
            t('a[data-toggle="tab"]', o).off("click", l), t('a[data-toggle="tab"]', o).off("shown shown.bs.tab", d), o = e.find("ul:first", e), a = o.find(r + ".active", e), t('a[data-toggle="tab"]', o).on("click", l), t('a[data-toggle="tab"]', o).on("shown shown.bs.tab", d), n.fixNavigationButtons()
        }, o = e.find("ul:first", e), a = o.find(r + ".active", e), o.hasClass(s.tabClass) || o.addClass(s.tabClass), s.onInit && "function" == typeof s.onInit && s.onInit(a, o, 0), s.onShow && "function" == typeof s.onShow && s.onShow(a, o, n.nextIndex()), t('a[data-toggle="tab"]', o).on("click", l), t('a[data-toggle="tab"]', o).on("shown shown.bs.tab", d)
    };
    t.fn.bootstrapWizard = function(i) {
        ...
        return this.each(function(n) {
            ...
            if (!r.data("bootstrapWizard")) {
                var s = new e(r, i);
                r.data("bootstrapWizard", s), s.fixNavigationButtons()
            }
        })
    ...
    t.expr[":"].notmdproc = function(e) {
        ...
        input: function(e) {
            t(e || this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function() {
                ...
                if (t.each({
                    ...
                    var r = e.attr("id"),
                        s = "";
                    r && (s = "for='" + r + "'"), i.addClass("label-floating"), e.after("<label " + s + "class='control-label'>" + n + "</label>")
        ...
        attachInputEventHandlers: function() {
            ...
            t(document).on("change", ".checkbox input[type=checkbox]", function() {
                ...
                "" === e.val() ? n.addClass("is-empty") : n.removeClass("is-empty"), i && (r ? n.removeClass("has-error") : n.addClass("has-error"))
...
function(t, e, i, n) {
    ...
    function r(e, i) {
        a = this, this.element = t(e), this.options = t.extend({}, o, i), this._defaults = o, this._name = s, this.init()
    }
    var s = "ripples",
        a = null,
        o = {};
    r.prototype.init = function() {
            ...
            if (!a.isTouch() || "mousedown" !== n.type) {
                ...
                if (s || o) {
                    ...
                    d.addClass("ripple").css({
                        ...
                        top: s,
                        "background-color": l
                    }), r.append(d), e.getComputedStyle(d[0]).opacity, a.rippleOn(i, d), setTimeout(function() {
                        a.rippleEnd(d)
                    }, 500), i.on("mouseup mouseleave touchend", function() {
                        d.data("mousedown", "off"), "off" === d.data("animating") && a.rippleOut(d)
                    })
                }
            }
        })
...
}(jQuery, window, document), searchVisible = 0, transparent = !0, $(document).ready(function() {
        $.material.init(), $('[rel="tooltip"]').tooltip();
        ...
        $(".wizard-card").bootstrapWizard({
            ...
            onInit: function(t, e, i) {
                ...
                $display_width = $(document).width(), $display_width < 600 && n > 3 && ($width = 50), e.find("li").css("width", $width + "%"), $first_li = e.find("li:first-child a").html(), $moving_div = $('<div class="moving-tab">' + $first_li + "</div>"), $(".wizard-card .wizard-navigation").append($moving_div), refreshAnimation(r, i), $(".moving-tab").css("transition", "transform 0s")
            },
            ...
            onTabShow: function(t, e, i) {
                ...
                r >= n ? ($(s).find(".btn-next").hide(), $(s).find(".btn-finish").show()) : ($(s).find(".btn-next").show(), $(s).find(".btn-finish").hide()), button_text = e.find("li:nth-child(" + r + ") a").html(), setTimeout(function() {
            ...
            wizard = $(this).closest(".wizard-card"), wizard.find('[data-toggle="wizard-radio"]').removeClass("active"), $(this).addClass("active"), $(wizard).find('[type="radio"]').removeAttr("checked"), $(this).find('[type="radio"]').attr("checked", "true")
        ...
        $(".wizard-card").each(function() {
            $wizard = $(this), index = $wizard.bootstrapWizard("currentIndex"), refreshAnimation($wizard, index), $(".moving-tab").css({
                transition: "transform 0s"
            })
        })
    }), materialDesign = {
        checkScrollForTransparentNavbar: debounce(function() {
            $(document).scrollTop() > 260 ? transparent && (transparent = !1, $(".navbar-color-on-scroll").removeClass("navbar-transparent")) : transparent || (transparent = !0, $(".navbar-color-on-scroll").addClass("navbar-transparent"))
        }, 17)
    },
    function(t) {
        ...
        t.extend(t.fn, {
            ...
            rules: function(e, i) {
                ...
                if (e) switch (n = t.data(d.form, "validator").settings, r = n.rules, s = t.validator.staticRules(d), e) {
                    case "add":
                        t.extend(s, t.validator.normalizeRule(i)), delete s.messages, r[d.name] = s, i.messages && (n.messages[d.name] = t.extend(n.messages[d.name], i.messages));
                        break;
                    case "remove":
                ...
                return (a = t.validator.normalizeRules(t.extend({}, t.validator.classRules(d), t.validator.attributeRules(d), t.validator.dataRules(d), t.validator.staticRules(d)), d)).required && (o = a.required, delete a.required, a = t.extend({
                    required: o
                }, a), t(d).attr("aria-required", "true")), a.remote && (o = a.remote, delete a.remote, a = t.extend(a, {
                    remote: o
                })), a
            }
        }), t.extend(t.expr[":"], {
            ...
            prototype: {
                ...
                element: function(e) {
                    var i = this.clean(e),
                        ...
                        r = !0;
                    return this.lastElement = n, void 0 === n ? delete this.invalid[i.name] : (this.prepareElement(n), this.currentElements = t(n), (r = !1 !== this.check(n)) ? delete this.invalid[n.name] : this.invalid[n.name] = !0), t(e).attr("aria-invalid", !r), this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), r
                },
                ...
                showLabel: function(e, i) {
                    ...
                    a.length ? (a.removeClass(this.settings.validClass).addClass(this.settings.errorClass), a.html(i)) : (n = a = t("<" + this.settings.errorElement + ">").attr("id", o + "-error").addClass(this.settings.errorClass).html(i || ""), this.settings.wrapper && (n = a.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(n) : this.settings.errorPlacement ? this.settings.errorPlacement(n, t(e)) : n.insertAfter(e), a.is("label") ? a.attr("for", o) : 0 === a.parents("label[for='" + o + "']").length && (s = a.attr("id").replace(/(:|\.|\[|\]|\$)/g, "\\$1"), l ? l.match(new RegExp("\\b" + s + "\\b")) || (l += " " + s) : l = s, t(e).attr("aria-describedby", l), (r = this.groups[e.name]) && t.each(this.groups, function(e, i) {
            ...
            dataRules: function(e) {
                var i, n, r = {},
                    s = t(e),
                    a = e.getAttribute("type");
                for (i in t.validator.methods) n = s.data("rule" + i.charAt(0).toUpperCase() + i.substring(1).toLowerCase()), this.normalizeAttributeRule(r, a, i, n);
                return r
            },
            ...
            methods: {
                ...
                creditcard: function(t, e) {
                    ...
                    for (i = t.length - 1; i >= 0; i--) n = t.charAt(i), s = parseInt(n, 10), a && (s *= 2) > 9 && (s -= 9), r += s, a = !a;
                    return r % 10 == 0
                },
                ...
                remote: function(e, i, n) {
                    ...
                    return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), a.originalMessage = this.settings.messages[i.name].remote, this.settings.messages[i.name].remote = a.message, n = "string" == typeof n && {
                        url: n
                    } || n, a.old === e ? a.valid : (a.old = e, r = this, this.startRequest(i), (s = {})[i.name] = e, t.ajax(t.extend(!0, {
                        mode: "abort",
                        ...
                        success: function(n) {
                            ...
                            r.settings.messages[i.name].remote = a.originalMessage, d ? (l = r.formSubmitted, r.prepareElement(i), r.formSubmitted = l, r.successList.push(i), delete r.invalid[i.name], r.showErrors()) : (s = {}, o = n || r.defaultMessage(i, "remote"), s[i.name] = a.message = t.isFunction(o) ? o(e) : o, r.invalid[i.name] = !0, r.showErrors(s)), a.valid = d, r.stopRequest(i, d)
                        }
                    }, n)), "pending")
                }
            }
