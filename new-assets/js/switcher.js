jQuery(window).load(function() {
    ...
    jQuery(".nav-width li ").on("click", function() {
        jQuery(".nav-width li ").removeClass("active"), jQuery(this).addClass("active")
    }), jQuery(".nav-wide").on("click", function() {
        jQuery(".site-header").addClass("nav-wide"), jQuery(".site-header").removeClass("nav-boxed")
    }), jQuery(".nav-boxed").on("click", function() {
        jQuery(".site-header").addClass("nav-boxed"), jQuery(".site-header").removeClass("nav-wide")
    })
}), jQuery(document).ready(function() {
